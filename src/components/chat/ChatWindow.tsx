...
import { Users, Globe, Lock, MessageCircle, ChevronDown } from 'lucide-react';
    ...
    return (
        <div className="flex-1 flex flex-col h-full relative overflow-hidden transition-colors duration-300"
            ...
            <motion.header
                ...
                className="h-16 flex-shrink-0 flex items-center justify-between px-6 border-b backdrop-blur-md z-20 relative"
